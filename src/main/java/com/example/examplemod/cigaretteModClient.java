...
@Mod(value = cigaretteMod.MODID, dist = Dist.CLIENT)
public class cigaretteModClient {
    private static KeyMapping editAddictionHudKey;

    public cigaretteModClient(IEventBus modEventBus, ModContainer container) {
        modEventBus.addListener(cigaretteModClient::registerClientExtensions);
        modEventBus.addListener(cigaretteModClient::registerKeyMappings);
        NeoForge.EVENT_BUS.addListener(CigaretteDizzyVisuals::onClientTick);
        NeoForge.EVENT_BUS.addListener(cigaretteModClient::onClientTick);
        ...
        NeoForge.EVENT_BUS.addListener(cigaretteModClient::onClientLogout);
    ...
    private static void registerKeyMappings(RegisterKeyMappingsEvent event) {
        editAddictionHudKey = new KeyMapping(
                "key.cigarettemod.edit_addiction_hud",
                InputConstants.Type.KEYSYM,
                InputConstants.KEY_H,
                "key.categories.cigarettemod");
    ...
    static void registerClientExtensions(RegisterClientExtensionsEvent event) {
        ...
        }, cigaretteMod.allCigaretteItems());
    }
}
